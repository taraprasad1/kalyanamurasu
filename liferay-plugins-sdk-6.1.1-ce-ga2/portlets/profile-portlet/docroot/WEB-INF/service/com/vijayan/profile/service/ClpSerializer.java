...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"profile-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "profile-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.vijayan.profile.model.impl.KeyImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.vijayan.profile.NoSuchKeyException")) {
			return new com.vijayan.profile.NoSuchKeyException();
		}

		if (className.equals("com.vijayan.profile.NoSuchKeyValueException")) {
