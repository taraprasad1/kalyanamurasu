...
package com.matrimony.profile.service.persistence;
...
import com.matrimony.profile.model.impl.KeyValueModelImpl;
...
public class KeyValuePersistenceImpl extends BasePersistenceImpl<KeyValue>
	 ...
	 * @throws com.matrimony.profile.NoSuchKeyValueException if a key value with the primary key could not be found
	...
	@Override
	public KeyValue updateImpl(com.matrimony.profile.model.KeyValue keyValue,
	...
	/**
	 * Returns the key value with the primary key or throws a {@link com.matrimony.profile.NoSuchKeyValueException} if it could not be found.
	 *
	 * @param valueId the primary key of the key value
	 * @return the key value
	 * @throws com.matrimony.profile.NoSuchKeyValueException if a key value with the primary key could not be found
	 ...
	 * @throws com.matrimony.profile.NoSuchKeyValueException if a matching key value could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Returns the key value where name = &#63; and keyId = &#63; or throws a {@link com.matrimony.profile.NoSuchKeyValueException} if it could not be found.
	 *
	 * @param name the name
	 * @param keyId the key ID
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.matrimony.profile.model.KeyValue")));
