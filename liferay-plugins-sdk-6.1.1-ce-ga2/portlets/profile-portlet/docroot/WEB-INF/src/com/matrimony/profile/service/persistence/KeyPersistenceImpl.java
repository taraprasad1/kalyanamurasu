...
import com.matrimony.profile.model.impl.KeyModelImpl;
...
public class KeyPersistenceImpl extends BasePersistenceImpl<Key>
	 ...
	 * @throws com.matrimony.profile.NoSuchKeyException if a key with the primary key could not be found
	...
	@Override
	public Key updateImpl(com.matrimony.profile.model.Key key, boolean merge)
	...
	/**
	 * Returns the key with the primary key or throws a {@link com.matrimony.profile.NoSuchKeyException} if it could not be found.
	 *
	 * @param keyId the primary key of the key
	 * @return the key
	 * @throws com.matrimony.profile.NoSuchKeyException if a key with the primary key could not be found
	...
	/**
	 * Returns the key where name = &#63; or throws a {@link com.matrimony.profile.NoSuchKeyException} if it could not be found.
	 *
	 * @param name the name
	 * @return the matching key
	 * @throws com.matrimony.profile.NoSuchKeyException if a matching key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.matrimony.profile.model.Key")));
