...
/**
 * The persistence utility for the profile temp service. This utility wraps {@link ProfileTempPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ProfileTempUtil {
	 ...
	 */
	public static void clearCache(ProfileTemp profileTemp) {
		getPersistence().clearCache(profileTemp);
	}
	 ...
	 */
	public static List<ProfileTemp> findWithDynamicQuery(
	 ...
	 */
	public static ProfileTemp update(ProfileTemp profileTemp, boolean merge)
		throws SystemException {
		return getPersistence().update(profileTemp, merge);
	}
	...
	public static ProfileTemp update(ProfileTemp profileTemp, boolean merge,
		...
		return getPersistence().update(profileTemp, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.matrimony.model.ProfileTemp profileTemp) {
		getPersistence().cacheResult(profileTemp);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(profileTemps);
	}
	...
	*/
	public static com.matrimony.model.ProfileTemp create(long profileTempId) {
		return getPersistence().create(profileTempId);
	}
	...
	*/
	public static com.matrimony.model.ProfileTemp remove(long profileTempId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.matrimony.NoSuchProfileTempException {
		return getPersistence().remove(profileTempId);
	}

	public static com.matrimony.model.ProfileTemp updateImpl(
		com.matrimony.model.ProfileTemp profileTemp, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(profileTemp, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.matrimony.model.ProfileTemp findByPrimaryKey(
		long profileTempId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.matrimony.NoSuchProfileTempException {
		return getPersistence().findByPrimaryKey(profileTempId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.matrimony.model.ProfileTemp fetchByPrimaryKey(
		long profileTempId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(profileTempId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.matrimony.model.ProfileTemp> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ProfileTempPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ProfileTempPersistence)PortletBeanLocatorUtil.locate(com.matrimony.service.ClpSerializer.getServletContextName(),
					ProfileTempPersistence.class.getName());

			ReferenceRegistry.registerReference(ProfileTempUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(ProfileTempPersistence persistence) {
	}

	private static ProfileTempPersistence _persistence;
}