...
import com.matrimony.profile.model.KeyValueModel;
import com.matrimony.profile.model.KeyValueSoap;
...
/**
 * The base model implementation for the KeyValue service. Represents a row in the &quot;matrimony_key_value&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.matrimony.profile.model.KeyValueModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link KeyValueImpl}.
 * </p>
 *
 * @author matrimony
 * @see KeyValueImpl
 * @see com.matrimony.profile.model.KeyValue
 * @see com.matrimony.profile.model.KeyValueModel
 * @generated
 */
@JSON(strict = true)
public class KeyValueModelImpl extends BaseModelImpl<KeyValue>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a key value model instance should use the {@link com.matrimony.profile.model.KeyValue} interface instead.
	 */
	public static final String TABLE_NAME = "matrimony_key_value";
	public static final Object[][] TABLE_COLUMNS = {
			{ "valueId", Types.BIGINT },
			{ "keyId", Types.BIGINT },
			{ "name", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table matrimony_key_value (valueId LONG not null primary key IDENTITY,keyId LONG,name VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table matrimony_key_value";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.matrimony.profile.model.KeyValue"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.matrimony.profile.model.KeyValue"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.matrimony.profile.model.KeyValue"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.matrimony.profile.model.KeyValue"));
	...
	public String toXmlString() {
		...
		sb.append("com.matrimony.profile.model.KeyValue");
