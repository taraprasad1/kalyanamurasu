...
/**
 * The base implementation of the profile key value local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.matrimony.service.impl.ProfileKeyValueLocalServiceImpl}.
 * </p>
 *
 * @author matrimony
 ...
 * @generated
 */
public abstract class ProfileKeyValueLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProfileKeyValueLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.matrimony.service.ProfileKeyValueLocalServiceUtil} to access the profile key value local service.
	 */
	...
	public ProfileKeyValue addProfileKeyValue(ProfileKeyValue profileKeyValue)
		throws SystemException {
		profileKeyValue.setNew(true);

		return profileKeyValuePersistence.update(profileKeyValue, false);
	}
	 ...
	 */
	public ProfileKeyValue createProfileKeyValue(
		ProfileKeyValuePK profileKeyValuePK) {
		return profileKeyValuePersistence.create(profileKeyValuePK);
	}
	...
	public ProfileKeyValue deleteProfileKeyValue(
		ProfileKeyValuePK profileKeyValuePK)
		throws PortalException, SystemException {
		return profileKeyValuePersistence.remove(profileKeyValuePK);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	public ProfileKeyValue deleteProfileKeyValue(
		ProfileKeyValue profileKeyValue) throws SystemException {
		return profileKeyValuePersistence.remove(profileKeyValue);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ProfileKeyValue.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return profileKeyValuePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return profileKeyValuePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ProfileKeyValue fetchProfileKeyValue(
		ProfileKeyValuePK profileKeyValuePK) throws SystemException {
		return profileKeyValuePersistence.fetchByPrimaryKey(profileKeyValuePK);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ProfileKeyValue getProfileKeyValue(
		ProfileKeyValuePK profileKeyValuePK)
		throws PortalException, SystemException {
		return profileKeyValuePersistence.findByPrimaryKey(profileKeyValuePK);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return profileKeyValuePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ProfileKeyValue> getProfileKeyValues(int start, int end)
		throws SystemException {
		return profileKeyValuePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getProfileKeyValuesCount() throws SystemException {
		return profileKeyValuePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ProfileKeyValue updateProfileKeyValue(
		ProfileKeyValue profileKeyValue) throws SystemException {
		return updateProfileKeyValue(profileKeyValue, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public ProfileKeyValue updateProfileKeyValue(
		ProfileKeyValue profileKeyValue, boolean merge)
		throws SystemException {
		profileKeyValue.setNew(false);

		return profileKeyValuePersistence.update(profileKeyValue, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.matrimony.model.ProfileKeyValue",
			profileKeyValueLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = profileKeyValuePersistence.getDataSource();
	...
	private ProfileKeyValueLocalServiceClpInvoker _clpInvoker = new ProfileKeyValueLocalServiceClpInvoker();
}